...
plotCov <- function(df, i){
  ...
  p2 <- p1 + scale_fill_gradient2(low = "blue", mid = "purple, high = "red", midpoint = 1, breaks = c(seq(.2, .8, by = .2),  seq(1,1.5,by=.1)), labels = paste(c(seq(.2, .8, by=.2), seq(1,6, by = 1)),"x"), limits = c(.2,1.5))
